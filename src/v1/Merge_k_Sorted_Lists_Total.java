...
//    	if(size2 == 0)
//     	   return mergeKLists(lists2.subList(0, size2/2),lists1.subList(size2/2, size2));
//    	if(size1 == 1)
//     	   return merge2Lists(lists1.get(0),mergeKLists(lists2.subList(0, size2/2),lists1.subList(size2/2, size2)));
//     	if(size2 == 1)
//      	   return merge2Lists(lists2.get(0),mergeKLists(lists1.subList(0, size1/2),lists1.subList(size1/2, size1)));
